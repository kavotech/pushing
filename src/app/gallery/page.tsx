...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Real project photos plus before and after examples of pressure washing, softwashing and exterior cleaning work from Pushing Pressure LTD across South, North, West and East London.",
  path: "/gallery",
});
  ...
  return (
    <>
      <PageHero
        ...
        description="Real project photos from across South, North, West and East London, plus example transformations below."
