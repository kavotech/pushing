...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Request a free, no-obligation quote from Pushing Pressure LTD for pressure washing, softwashing or exterior cleaning across South, North, West and East London.",
  path: "/quote",
});
