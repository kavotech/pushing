...
export const metadata: Metadata = buildMetadata({
  title: "About Us",
  description:
    "Pushing Pressure LTD provides professional exterior cleaning solutions for residential, communal, estate and commercial properties across South, North, West and East London.",
  path: "/about",
});
...
const values = [
  ...
  },
  {
    ...
    description:
      "One team working across South, North, West and East London — useful whether you manage one property or several.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        description="Pushing Pressure LTD provides professional exterior cleaning solutions for residential, communal, estate and commercial properties across South, North, West and East London."
        ...
        <Container className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <Reveal>
            <SectionHeading
              ...
              title="Covering South, North, West & East London"
              description="We take on domestic, communal, estate and commercial work across all four areas, with the flexibility to travel further for larger estate and commercial contracts."
              tone="light"
            />
          </Reveal>
          <Reveal delay={0.1}>
