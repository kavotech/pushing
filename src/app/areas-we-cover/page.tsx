...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Pushing Pressure LTD provides exterior cleaning across South, North, West and East London — covering domestic, communal, estate and commercial properties.",
  path: "/areas-we-cover",
});
  ...
  return (
    <>
      <PageHero
        ...
        description="We carry out pressure washing, softwashing and exterior cleaning across South, North, West and East London — from city apartment blocks to estate properties and business premises."
