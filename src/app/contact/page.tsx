...
export const metadata: Metadata = buildMetadata({
  title: "Contact Us",
  description:
    "Get in touch with Pushing Pressure LTD for professional exterior cleaning across South, North, West and East London.",
  path: "/contact",
});
            ...
            <div className="space-y-6">
              ...
              <ContactCard icon={MapPin} title="Where we work">
                <p className="text-sm text-ink-500">
                  Covering South, North, West and East London for domestic, communal, estate and
